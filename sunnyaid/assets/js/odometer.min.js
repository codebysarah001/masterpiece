...
(function() {
    ...
    q = '<span class="xbo-value"></span>',
    n = '<span class="xbo-ribbon"><span class="xbo-ribbon-inner">' + q + "</span></span>",
    d = '<span class="xbo-digit"><span class="xbo-digit-spacer">8</span><span class="xbo-digit-inner">' + n + "</span></span>",
    g = '<span class="xbo-formatting-mark"></span>',
    c = "(,ddd).dd",
    h = /^\(?([^)]*)\)?(?:(.)(d+))?$/,
    i = 30,
    f = 2e3,
    ...
    m = function() {
        ...
        return a.prototype.renderInside = function() {
            ...
            this.inside.className = "xbo-inside",
            this.el.innerHTML = "",
        ...
        a.prototype.render = function(a) {
            ...
            h = b.length; h > g; g++)
                c = b[g],
                c.length && ((d = /^xbo-theme-(.+)$/.exec(c)) ? f = d[1] : /^xbo(-|$)/.test(c) || e.push(c));
            return e.push("xbo"),
            p || e.push("xbo-no-transitions"),
            f ? e.push("xbo-theme-" + f) : e.push("xbo-auto-theme"),
        ...
        a.prototype.formatDigits = function(a) {
            ...
            this.options.formatFunction)
                ...
                h = j.length; h > f; f++)
                    ...
                    b.querySelector(".xbo-value").innerHTML = c,
                    this.digits.push(b),
        ...
        a.prototype.update = function(a) {
            ...
            (b = a - this.value) ? (v(this.el, "xbo-animating-up xbo-animating-down xbo-animating"),
            b > 0 ? r(this.el, "xbo-animating-up") : r(this.el, "xbo-animating-down"),
            this.stopWatchingMutations(),
            this.animate(a),
            this.startWatchingMutations(),
            setTimeout(function() {
                return c.el.offsetHeight,
                r(c.el, "xbo-animating")
            }, 0),
            this.value = a) : void 0
        }
        ,
        ...
        a.prototype.addDigit = function(a, b) {
            ...
            if (null == b && (b = !0),
            "-" === a)
                return this.addSpacer(a, null, "xbo-negation-mark");
            if ("." === a)
                return this.addSpacer(null != (f = this.format.radix) ? f : ".", null, "xbo-radix-mark");
            if (b)
                for (e = !1; ; ) {
                    if (!this.format.repeating.length) {
                        if (e)
                            throw new Error("Bad xbo format without digits");
                        this.resetFormat(),
                        e = !0
                    }
            ...
            d.querySelector(".xbo-value").innerHTML = a,
            this.digits.push(d),
            this.insertDigit(d)
        }
        ,
        ...
        a.prototype.animateSlide = function(a) {
            ...
            d = a - s) {
                ...
                z = D.length; z > x; m = ++x)
                    ...
                    null == (u = this.ribbons)[m] && (u[m] = this.digits[m].querySelector(".xbo-ribbon-inner")),
                    ...
                    B = l.length; B > C; o = ++C)
                        ...
                        q.className = "xbo-value",
                        q.innerHTML = k,
                        this.ribbons[m].appendChild(q),
                        o === l.length - 1 && r(q, "xbo-last-value"),
                        0 === o && r(q, "xbo-first-value");
                return 0 > t && this.addDigit("-"),
                p = this.inside.querySelector(".xbo-radix-mark"),
                null != p && p.parent.removeChild(p),
                j ? this.addSpacer(this.format.radix, this.digits[j - 1], "xbo-radix-mark") : void 0
            }
        }
        ,
        a
    }(),
    m.options = null != (E = window.xboOptions) ? E : {},
    setTimeout(function() {
        var a, b, c, d, e;
    ...
    m.init = function() {
        ...
        if (null != document.querySelectorAll) {
            for (b = document.querySelectorAll(m.options.selector || ".xbo"),
            f = [],
            c = 0,
            d = b.length; d > c; c++)
                a = b[c],
